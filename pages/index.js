              ...
              <div className="grid sm:grid-cols-2 gap-14">
                ...
                <div className="text-gray-400">
                  ...
                  <p className="py-2 sm:py-4 sm:text-lg">
                    ...
                    passionate about design, development, traveling, and a
                    fanatic of all things digital.
                  </p>
                  <p className="py-2 sm:py-4 sm:text-lg">
                    I have been very fortunate to be able to do all as a career.
                    I consider myself a learner, a life-long learner.
                  </p>
                  <p className="py-2 sm:py-4 sm:text-lg">
